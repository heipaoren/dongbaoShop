package com.xskj.dongbaogenerator;
...
public class DongbaoGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\IdeaWorkSpace2022\\msb-dongbao-mall-parent\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setAuthor("王家欣");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/dbshop?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.xskj.dongbaoums");
        pc.setEntity("entity");
        pc.setMapper("mapper");
